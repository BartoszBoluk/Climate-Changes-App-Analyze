...
public class AnalyzeAcroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analize_acro);
        ...
        mProgressBar = findViewById(R.id.progressBarAcro);
    ...
    class Content extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            if (finaResultFirstDate > finalResultSecondDate) {
                ...
                if (noData == true) {
                    mResult.setText(Html.fromHtml("<font color=red>" + "Wynik niepewny." +
                            "</font><br>" + "Wartość rocznej uśrednionej wartości " +
                ...
                if (noData == true) {
                    mResult.setText(Html.fromHtml("<font color=red>" + "Wynik niepewny." +
                            "</font><br>" + "Wartość rocznej uśrednionej wartości " +
                            "całkowitego promieniowania zwiększyła się o " +
                            new DecimalFormat("###.##").format(finalResult) + " %."));
                } else {
